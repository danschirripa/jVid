...
public class StringUtil
{
	...
	public static String atLeast(int length,   String string,   String padding, boolean leftSide)
	{
		if(padding.isEmpty())
	...
	public static String[] capturesOf(  String input,     String regex) throws PatternSyntaxException
	{
	...
	public static String[] capturesOf(  String input,   Pattern pattern)
	{
	...
	public static String captureOf(  String input,     String regex) throws PatternSyntaxException
	{
	...
	public static String captureOf(  String input,   Pattern pattern)
	{
	...
	public static List<String[]> findAllCapturesOf(  String input,     String regex) throws PatternSyntaxException
	{
	...
	public static List<String[]> findAllCapturesOf(  String input,   Pattern pattern)
	{
		Matcher matcher = pattern.matcher(input);
	...
	public static String[] findCapturesOf(  String input,     String regex) throws PatternSyntaxException
	{
	...
	public static String[] findCapturesOf(  String input,   Pattern pattern)
	{
	...
	public static String findCaptureOf(  String input,     String regex) throws PatternSyntaxException
	{
	...
	public static String findCaptureOf(  String input,   Pattern pattern)
	{
		List<String[]> strs = findAllCapturesOf(input, pattern);
		if(strs.isEmpty())
			return null;
