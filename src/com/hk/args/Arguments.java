...
//		workingDirectory = Paths.get(System.getProperty("user.dir"));
	 ...
	 *          isn't an argument.
	 */
	public int index(  String str, boolean ignoreCase)
	{
		if(str == null)
	...
	public static Arguments parseLine(  String line)
	{
	...
	public static class Builder
	{
		...
		public Builder addAll(  String[] args)
		{
		...
		public Builder addAll(  Collection<String> args)
		{
			list.addAll(args);
			return this;
		}
