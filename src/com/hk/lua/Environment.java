...
/**
 * <p>
 * This class encapsulates a Lua environment. A Lua environment consists of
 * global and local variables which are all accessible through this utility.
 * </p>
 *
 * @author theKayani
 */
public class Environment {
	...
	/**
	 * <p>
	 * This method sets a value to a variable. If the variable is local, this will
	 * reassign the local variable. If the variable is global or doesn't exist yet,
	 * this will assign the global variable.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * This method explicitly sets the local variable with the given name to the
	 * given value. If the local variable already exists, it will reassign the local
	 * variable. If the local variable doesn't exist, it will assign the value to
	 * the local variable.
	 * </p>
	 * <p>
	 * If there is a global variable with this name, it is left untouched. This
	 * method does not affect the global space.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Retrieve the value of the variable under the specified name. If this variable
	 * exists in the local space, this method will return the local value. Otherwise
	 * it will return the global value if one exists. If one does not exist in the
	 * global space, this will return <code>nil</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Retrieve the value of the variable under the specified key. If this variable
	 * exists in the local space, this method will return the local value. Otherwise
	 * it will return the global value if one exists. If one does not exist in the
	 * global space, this will return <code>nil</code>.
	 * </p>
