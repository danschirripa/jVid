...
public class FFMPEGIngestToQOVFile {
	private File inputFile;
	private String outputFile;
	private final String fileExtension = ".qov";
	private FFmpegFrameGrabber grab;
	private final QOIStreamEgressorC qoiOut;
	private Java2DFrameConverter conv;
	private int subSegments = 12;

	public FFMPEGIngestToQOVFile(File inputFile, String outputFile) {
		qoiOut = new QOIStreamEgressorC(new Dimension(1920, 1080));
	...
	public void runConversion() throws IOException {
		...
		while (true) {
			...
			boolean isKey = false;
			final byte[][] nextEncodedFrame = qoiOut.convertFromBufferedImage(bufFrame, preImg, curVideoFrame == 1, 12);
